      ...
      <section className="mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {displayProofs.slice(0, 6).map((proof: any, idx: number) => (
            ...
            >
              {/* Image Section */}
              <div className="aspect-[4/3] relative overflow-hidden bg-[#1E293B]">
                <img
                  src={proof.url}
                  alt={proof.title}
                  className="w-full h-full object-contain p-2 group-hover:scale-105 transition-transform duration-1000"
                  loading="lazy"
                />
